...
/// <summary>
/// An Axis control displayed on screen and moved around by touch or other pointer
/// input.
/// </summary>
...
public class OnScreenAxis : OnScreenControl, IPointerDownHandler, IPointerUpHandler, IDragHandler {
	...
	public void OnDrag(PointerEventData eventData) {
		...
		var newPos = new Vector2((delta.x / movementRange)*Axis.x, (delta.y / movementRange)*Axis.y);
